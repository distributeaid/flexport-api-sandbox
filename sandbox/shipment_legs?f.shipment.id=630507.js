module.exports = {
	...
	self: 'https://api.flexport.com/shipment_legs?f.shipment.id=630507',
	version: 2,
	data: {
		...
		data: [
			{
				...
				carrier_name: 'EVA Airways Corporation',
				ocean_leg: null,
				air_leg: {
			...
			},
			{
				...
				origin: {
					...
					place: {
						_object: '/place',
						name: 'Shipco LAX Air Cargo',
						address: {
							_object: '/address',
							street_address: '5341 W 104th Street',
							street_address2: null,
							city: 'Los Angeles',
							state: 'CA',
							country: 'United States',
