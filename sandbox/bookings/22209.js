module.exports = {
	...
	self: 'https://api.flexport.com/bookings/22209',
	version: 2,
	data: {
		metadata: {},
		_object: '/booking',
			...
			product_descriptions: [
				{
					...
					hs_code: {
						_object: '/hs_code',
						description:
							': Sports footwear; tennis shoes, basketball shoes, gym shoes, training shoes and the like, all the foregoing with outer soles of rubber or plastics and uppers of textile materials for women (provided for in subheading 6404.11.20)',
						code: '9902.90',
						country_code: 'US',
					},
				},
		...
		cargo: {
			...
			contains_non_li_ion_battery: null,
		...
		booking_line_items: {
			...
			link: 'https://api.flexport.com/booking_line_items?f.booking.id=22209',
		},
		created_at: '2018-04-17T11:35:36.198Z',
	},
	error: null,
}
