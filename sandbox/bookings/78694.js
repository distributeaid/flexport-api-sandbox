module.exports = {
	...
	self: 'https://api.flexport.com/bookings/78694',
	version: 2,
	data: {
		metadata: {},
		_object: '/booking',
			...
			product_descriptions: [
				{
					...
					description: 'Shoes',
					description_for_export_customs: '鞋',
		...
		cargo: {
			...
			marks_and_numbers: 'TEST BOOKING',
			shipping_units: [
				{
		...
		booking_line_items: {
			...
			link: 'https://api.flexport.com/booking_line_items?f.booking.id=78694',
		},
		created_at: '2019-02-19T08:54:18.686Z',
	},
	error: null,
}
