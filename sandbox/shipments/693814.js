module.exports = {
	...
	self: 'https://api.flexport.com/shipments/693814',
	version: 2,
	data: {
		metadata: {},
		_object: '/shipment',
		id: 693814,
		name: 'Collaboration Testing!3',
		booking: {
		...
		priority: 'standard',
		updated_at: '2020-04-10T02:39:11.850Z',
		archived_at: null,
		...
		commercial_invoices: {
			...
			link: 'https://api.flexport.com/commercial_invoices?f.shipment.id=693814',
		},
		documents: {
			_object: '/api/refs/collection',
			ref_type: '/document',
